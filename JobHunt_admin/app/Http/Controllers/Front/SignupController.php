...
class SignupController extends Controller
{
    ...
    public function company_signup_verify($token, $email){
       ...
       return redirect()->route('login')->with('success','Your emial is verified successfully. You can now login to the system as company. ');
    ...
    public function candidate_signup_verify($token, $email){
       ...
       return redirect()->route('login')->with('success','Your emial is verified successfully. You can now login to the system as candidate. ');
