...
class AdminBannerController extends Controller
{
    ...
    public function update(Request $request){
        ...
        if ($request->hasFile('banner_job_listing')) {
            ...
            if (file_exists(public_path('uploads/'.$obj->banner_job_listing))) {
        ...
        if ($request->hasFile('banner_job_detail')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_job_detail))) {
        ...
        if ($request->hasFile('banner_job_categories')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_job_categories))) {
        ...
        if ($request->hasFile('banner_company_listing')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_company_listing))) {
        ...
        if ($request->hasFile('banner_company_detail')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_company_detail))) {
        ...
        if ($request->hasFile('banner_pricing')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_pricing))) {
        ...
        if ($request->hasFile('banner_blog')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_blog))) {
        ...
        if ($request->hasFile('banner_post')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_post))) {
        ...
        if ($request->hasFile('banner_faq')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_faq))) {
        ...
        if ($request->hasFile('banner_contact')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_contact))) {
        ...
        if ($request->hasFile('banner_terms')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_terms))) {
        ...
        if ($request->hasFile('banner_privacy')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_privacy))) {
        ...
        if ($request->hasFile('banner_signup')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_signup))) {
        ...
        if ($request->hasFile('banner_login')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_login))) {
        ...
        if ($request->hasFile('banner_forget_password')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_forget_password))) {
        ...
        if ($request->hasFile('banner_company_panel')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_company_panel))) {
        ...
        if ($request->hasFile('banner_candidate_panel')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$obj->banner_candidate_panel))) {
