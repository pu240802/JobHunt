...
class AdminHomePageController extends Controller
{
    ...
    public function update(Request $request){
        ...
        if ($request->hasFile('background')) {
            ...
            if (file_exists(public_path('uploads/'.$page_home_data->background))) {
        ...
        if ($request->hasFile('why_choose_background')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$page_home_data->why_choose_background))) {
        ...
        if ($request->hasFile('testimonial_background')) {
            ...
            // Kiểm tra xem tệp tin cũ tồn tại hay không
            if (file_exists(public_path('uploads/'.$page_home_data->testimonial_background))) {
