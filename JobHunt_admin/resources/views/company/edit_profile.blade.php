            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <form action="{{ route('company_edit_profile_update') }}" method="POST" 
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('uploads/default_company_logo.png') }}" alt=""
                                        class="logo">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <select name="company_location_id" class="form_control select2">
                                            @foreach($company_locations as $item)
                                            <option value="{{ $item->id }}" 
                                                @if($item->id== Auth::guard('company')->user()->company_location_id)
                                                selected
                                                 @endif>
                                                 {{ $item->name }}</option>
                                            @endforeach
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <select name="company_industry_id" class="form_control select2">
                                            @foreach($company_industries as $item)
                                            <option value="{{ $item->id }}" 
                                                 @if($item->id== Auth::guard('company')->user()->company_industry_id)
                                                selected
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group">
                                        <select name="company_size_id" class="form_control select2">
                                            @foreach($company_sizes as $item)
                                            <option value="{{ $item->id }}" 
                                                @if($item->id== Auth::guard('company')->user()->company_size_id)
                                                selected
                                                 @endif>{{ $item->name }}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        >
                                         @for($i=1980;$i<=date('Y');$i++)
                                            <option value="{{ $i }}"
                                             @if($i == Auth::guard('company')->user()->founded_on)
                                                selected
                                                 @endif>{{ $i }}</option>
