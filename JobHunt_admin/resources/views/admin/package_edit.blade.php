                        ...
                        <div class="row">
                            <div class="col-md-6">                      
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="total_allowed_photo" value="{{ $package_single->total_allowed_photo }}" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="total_allowed_video" value="{{ $package_single->total_allowed_video }}">
                                </div>
                            </div>
                        </div>
