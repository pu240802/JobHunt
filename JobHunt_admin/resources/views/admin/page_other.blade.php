                            ...
                            <div class="row custom-tab">
                                <div class ="col-lg-3 col-md-12">
                                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <button class="nav-link" id="v-pills-5-tab" data-bs-toggle="pill" data-bs-target="#v-pills-5" type="button" role="tab" aria-controls="v-pills-5" aria-selected="false">Companay Listing Page</button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-4">
                                                       ...
                                                       <textarea name="login_page_meta_description" class="form-control h_100" cols="30" rows="">{{ $page_other_data->login_page_meta_description }}</textarea>
                                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab" tabindex="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    <label class="form-label">Meta Description</label>
                                                   <textarea name="signup_page_meta_description" class="form-control h_100" cols="30" rows="">{{ $page_other_data->signup_page_meta_description }}</textarea>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab" tabindex="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    <label class="form-label">Meta Description</label>
                                                   <textarea name="forget_password_page_meta_description" class="form-control h_100" cols="30" rows="">{{ $page_other_data->forget_password_page_meta_description }}</textarea>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-4-tab" tabindex="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    <label class="form-label">Meta Description</label>
                                                   <textarea name="job_listing_page_meta_description" class="form-control h_100" cols="30" rows="">{{ $page_other_data->job_listing_page_meta_description }}</textarea>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-5-tab" tabindex="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    <label class="form-label">Meta Description</label>
                                                   <textarea name="company_listing_page_meta_description" class="form-control h_100" cols="30" rows="">{{ $page_other_data->company_listing_page_meta_description }}</textarea>
                                                </div>
