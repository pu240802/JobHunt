                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6">
                                                                <div class="mb-4">
                                                                    ...
                                                                    <input type="job_title" class="form-control" name="job_title" value="{{ $page_home_data->job_title }}">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6">
                                                                <div class="mb-4">
                                                                    ...
                                                                    <input type="job_location" class="form-control" name="job_location" value="{{ $page_home_data->job_location }}">
                                                                </div>
                                                            </div>
                                                            <div class = row>
                                                                <div class="col-lg-6 col-md-6">
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <input type="job_category" class="form-control" name="job_category" value="{{ $page_home_data->job_category }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6">
                                                                    <div class="mb-4">
                                                                        <label class="form-label">Search*</label>
                                                                        <input type="search" class="form-control" name="search" value="{{ $page_home_data->search }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-4">
                                                                <label class="form-label">Exitting Background*</label>
                                                                <div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                   ...
                                                   <textarea name="meta_description" class="form-control h_100" cols="30" rows="">{{ $page_home_data->meta_description }}</textarea>
                                                </div>
