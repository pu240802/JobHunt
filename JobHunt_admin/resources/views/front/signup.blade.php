...
@section('seo_meta_description') {{ $other_page_item->signup_pagemeta_description }} @endsection

@section('main_content')

<div
    class="page-top"
    style="background-image: url('{{ asset('uploads/'.$global_banner_data->banner_signup) }}')"
>
<div class="bg"></div>
    <div class="container">
        <div class="row">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <form action="{{ route('company_signup_submit') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    type="text"
                                    class="form-control" name="company_name" value="{{ old('company_name') }}"
                                />
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label"
                                ...
                                <input
                                    type="text"
                                    class="form-control" name="person_name"
                                />
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label"
