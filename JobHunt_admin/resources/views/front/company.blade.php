                ...
                <div class="item d-flex justify-content-start">
                    ...
                    <div class="text">
                        ...
                        <div class="special">
                            ...
                            @if($company_single->facebook != null || $company_single->twitter != null||$company_single->linkedin != null
                            ...
                            <div class="social">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ $company_single->facebook }}" target="_blank"
                                            ><i
                                    ...
                                    <li>
                                        <a href="{{ $company_single->twitter }}"  target="_blank"
                                            ><i
                                    ...
                                    <li>
                                        <a href="{{ $company_single->linkedin }}"  target="_blank"
                                            ><i
                                    ...
                                    <li>
                                        <a href="{{ $company_single->instagram }}"  target="_blank"
                                            ><i
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                @if($company_single->oh_mon != null || $company_single->oh_tue != null ||
                $company_single->oh_wed != null ||$company_single->oh_thu != null ||
                $company_single->oh_fri != null ||$company_single->oh_sat != null ||
                                    ...
                                    <div class="col-md-12">
                                        <div
                                            ...
                                            <div class="logo">
                                                <img
                                                    src="
                                                    {{ asset('uploads/'.$company_single->logo) }}"
                                                    alt=""
                                                />
                                            </div>
                                            <div class="text">
                                                <h3>
                                                    <a href="{{ route('job', $item->id) }}"
                                                        >{{ $item->title }},{{ $company_single->company_name }}</a>
                                                </h3>
                                                <div
                                                    class="detail-1 d-flex justify-content-start"
                                                >
