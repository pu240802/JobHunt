        ...
        <div class="row">
            <div class="col-md-12 job job-single">
                <div class="item d-flex justify-content-start">
                    ...
                    <div class="text">
                        <h3>{{ $job_single->title }},
                            {{$job_single->rCompany->company_name }}</h3>
                        <div
                    ...
                    @endif
                        ...
                        <div class="apply">
                            @if(date('Y-m-d') <= $job_single->deadline)
                            <a href="{{ route('candidate_apply', $job_single->id) }}" class="btn btn-primary"
                                >Apply Now</a >
                            <a
                                href="{{ route('candidate_bookmark_add',$job_single->id)  }}"
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                        $deadline_timestamp = strtotime($job_single->deadline);
                                    @endphp
                                    
                                   
                                        {{ date('d F, Y', $deadline_timestamp) }}
                                ...
                                <tr>
                                    ...
                                    <td>{{ $job_single->rJobExperience ? $job_single->rJobExperience->name : 'N/A' }}</td>
