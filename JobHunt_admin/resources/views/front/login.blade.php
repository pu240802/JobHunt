...
@section('seo_meta_description') {{ $other_page_item->login_pagemeta_description }} @endsection

@section('main_content')

<div
    class="page-top"
    style="background-image: url('{{ asset('uploads/'.$global_banner_data->banner_login) }}')"
>
<div class="bg"></div>
    <div class="container">
        <div class="row">
