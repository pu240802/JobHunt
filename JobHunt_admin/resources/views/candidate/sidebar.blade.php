<ul class="list-group list-group-flush">
    ...
    <li class="list-group-item {{ Request::is('candidate/applications')? 'active' : ''}}">
        <a href="{{route('candidate_applications')}}"
            >Applied Jobs</a
        >
    </li>
    <li class="list-group-item {{ Request::is('candidate/bookmark_view')? 'active' : ''}}">
        <a href="{{ route('candidate_bookmark_view') }}"
            >Bookmarked Jobs</a
        >
    </li>
    ...
    <li class="list-group-item {{ Request::is('candidate/edit_profile')? 'active' : ''}}">
        <a href="{{ route('candidate_edit_profile') }}"
            >Edit Profile</a
        >
    </li>
    <li class="list-group-item {{ Request::is('candidate/edit_password')? 'active' : ''}}">
